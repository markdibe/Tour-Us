...
namespace IdentityAPI.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private async Task CheckRoles()
        {
            ...
            {
                await _roleManager.CreateAsync(new IdentityRole { Name = "Host", NormalizedName = "HOST" });
            }
        ...
        [HttpGet]
        public async Task<ActionResult<List<ApplicationUser>>> GetHostList()
        {
            var list = await _userManager.GetUsersInRoleAsync("Host");
            return Ok(list);
        }

        [HttpGet]
        public async Task<ActionResult<ApplicationUser>> GetHostById(string Id)
        {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterVM model)
        {
            ...
            var role_created = await _userManager.AddToRoleAsync(user, "Host");
